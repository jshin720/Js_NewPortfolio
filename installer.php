...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230124_jeffshinportfolio_83295371fd460b4e1938_20230127201230_archive.zip';
        const ARCHIVE_SIZE       = '72872253';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '8329537-27201230';
        const SECONDARY_PACKAGE_HASH = '278db45-27201230';
        const VERSION            = '1.5.2';
