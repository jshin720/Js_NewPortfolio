...
class b_Addon {
	...
	public function register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\b_html5_addon() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\b_html5_audio() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\b_youtube_vedio() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\b_vemio_vedio() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\b_art_addon() );
		//for bplayer
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Bplayer() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Bplayer_Playlist() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Bplayer_Video() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Bplayer_Video_Playlist() );
		//dplayer
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\d_player() );
